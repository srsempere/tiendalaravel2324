        ...
        <div class="p-2 flex-1 grid grid-cols-3 gap-4 justify-center justify-items-center"  >
            @foreach ($articulos as $articulo)
                    <div class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        <h1 class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <a href="{{ route('carrito.insertar', $articulo) }}" class="inline-block text-xs px-4 py-2 border rounded text-white bg-blue-700 hover:bg-blue-800">
                            Añadir al carrito
